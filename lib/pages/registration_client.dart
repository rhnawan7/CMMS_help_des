...
import 'package:maintenance/pages/widgets/header_widget.dart';
...
class _RegistrationPageState extends State<RegistrationPage>{
  ...
  TextEditingController _compantName = TextEditingController();
                  ...
                  Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 30,),
                        Container(
                          child: TextFormField(controller: _compantName,
                        ...
                        SizedBox(height: 20.0),
                        Container(
                          child: TextFormField(controller: _cellNo,
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              if (_formKey.currentState!.validate()) {
                                ...
                                createAccount(_name.text,_compantName.text,_email.text,_cellNo.text,_password.text).then((user) {
                                  if (user != null) {
